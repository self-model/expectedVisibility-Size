...
df = readtable('data/E_size_intersect.csv');
...
for seed=1:nseeds
    ...
    save('E_size_fit_intersect','fitted_parameters', 'LL', 'subj_data');
end
...
save('E_size_fit_intersect','fitted_parameters', 'LL', 'subj_data', 'best_parameters');
